// Flappy Birds game logic adapted for embedded screen and sessionStorage
...
function loadGameData() {
  ...
  statusText.textContent = `Player: ${playerName}`;
  return true;
}
...
window.startFlappy = function(gameData) {
  if (loadGameData()) {
    showScreen(document.getElementById("flappyGame"));
    gameLoop();
  }
};
